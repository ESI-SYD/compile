...
cd amp_bf16
echo -e "============ Acc Check for HF amp_bf16 ============" | tee -a /workspace/jenkins/e2e_summary.log
...
echo "num_total_amp_bf16: $num_total_amp_bf16" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_passed_amp_bf16_inf: $num_passed_amp_bf16_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_amp_bf16_inf: $num_failed_amp_bf16_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "amp_bf16_inf_acc_pass_rate: $amp_bf16_inf_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log
...
echo "num_passed_amp_bf16_tra: $num_passed_amp_bf16_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_amp_bf16_tra: $num_failed_amp_bf16_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "amp_bf16_tra_acc_pass_rate: $amp_bf16_tra_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log

cd ../amp_fp16
echo -e "============ Acc Check for HF amp_fp16 ============" | tee -a /workspace/jenkins/e2e_summary.log
...
echo "num_total_amp_fp16: $num_total_amp_fp16" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_passed_amp_fp16_inf: $num_passed_amp_fp16_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_amp_fp16_inf: $num_failed_amp_fp16_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "amp_fp16_inf_acc_pass_rate: $amp_fp16_inf_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log
...
echo "num_passed_amp_fp16_tra: $num_passed_amp_fp16_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_amp_fp16_tra: $num_failed_amp_fp16_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "amp_fp16_tra_acc_pass_rate: $amp_fp16_tra_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log

cd ../bfloat16
echo -e "============ Acc Check for HF bfloat16 ============" | tee -a /workspace/jenkins/e2e_summary.log        
...
echo "num_total_bfloat16: $num_total_bfloat16" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_passed_bfloat16_inf: $num_passed_bfloat16_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_bfloat16_inf: $num_failed_bfloat16_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "bfloat16_inf_acc_pass_rate: $bfloat16_inf_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log
...
echo "num_passed_bfloat16_tra: $num_passed_bfloat16_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_bfloat16_tra: $num_failed_bfloat16_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "bfloat16_tra_acc_pass_rate: $bfloat16_tra_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log

cd ../float16
echo -e "============ Acc Check for HF float16 ============" | tee -a /workspace/jenkins/e2e_summary.log        
...
echo "num_total_float16: $num_total_float16" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_passed_float16_inf: $num_passed_float16_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_float16_inf: $num_failed_float16_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "float16_inf_acc_pass_rate: $float16_inf_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log
...
echo "num_passed_float16_tra: $num_passed_float16_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_float16_tra: $num_failed_float16_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "float16_tra_acc_pass_rate: $float16_tra_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log

cd ../float32
echo -e "============ Acc Check for HF float32 ============" | tee -a /workspace/jenkins/e2e_summary.log        
...
echo "num_total_float32: $num_total_float32" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_passed_float32_inf: $num_passed_float32_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_float32_inf: $num_failed_float32_inf" | tee -a /workspace/jenkins/e2e_summary.log
echo "float32_inf_acc_pass_rate: $float32_inf_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log
num_passed_float32_tra=$(grep "pass" inductor_huggingface_float32_training_xpu_accuracy.csv | wc -l)
let num_failed_float32_tra=num_total_float32-num_passed_float32_tra
float32_tra_acc_pass_rate=`awk 'BEGIN{printf "%.2f%%",('$num_passed_float32_tra'/'$num_total_float32')*100}'`
echo "num_passed_float32_tra: $num_passed_float32_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "num_failed_float32_tra: $num_failed_float32_tra" | tee -a /workspace/jenkins/e2e_summary.log
echo "float32_tra_acc_pass_rate: $float32_tra_acc_pass_rate" | tee -a /workspace/jenkins/e2e_summary.log

echo -e "========================================================================="
echo -e "timm_models accuracy results check"
echo -e "========================================================================="

cd /workspace/pytorch/inductor_log/timm_models
cd amp_bf16
echo -e "============ Acc Check for TM amp_bf16 ============" | tee -a /workspace/jenkins/e2e_summary.log
...
cd ../amp_fp16
echo -e "============ Acc Check for TM amp_fp16 ============" | tee -a /workspace/jenkins/e2e_summary.log
...
cd ../bfloat16
echo -e "============ Acc Check for TM bfloat16 ============" | tee -a /workspace/jenkins/e2e_summary.log        
...
cd ../float16
echo -e "============ Acc Check for TM float16 ============" | tee -a /workspace/jenkins/e2e_summary.log        
...
cd ../float32
echo -e "============ Acc Check for TM float32 ============" | tee -a /workspace/jenkins/e2e_summary.log        
...
cd amp_bf16
echo -e "============ Acc Check for torchbench amp_bf16 ============" | tee -a /workspace/jenkins/e2e_summary.log
...
cd ../amp_fp16
echo -e "============ Acc Check for torchbench amp_fp16 ============" | tee -a /workspace/jenkins/e2e_summary.log
...
cd ../bfloat16
echo -e "============ Acc Check for torchbench bfloat16 ============" | tee -a /workspace/jenkins/e2e_summary.log        
...
cd ../float16
echo -e "============ Acc Check for torchbench float16 ============" | tee -a /workspace/jenkins/e2e_summary.log        
...
cd ../float32
echo -e "============ Acc Check for torchbench float32 ============" | tee -a /workspace/jenkins/e2e_summary.log        
