...
SUMMARY_FILE=$WORKSPACE/e2e_summary.log

echo -e "========================================================================="
echo -e "SUMMARY_FILE located in $SUMMARY_FILE"
echo -e "========================================================================="

if [[ $SUITE == "huggingface" || $SUITE == "all" ]]; then
    echo -e "========================================================================="
    echo -e "huggingface accuracy results check"
    echo -e "========================================================================="
    cd ${WORKSPACE}/inductor_log/huggingface
    cd amp_bf16
    echo -e "============ Acc Check for HF amp_bf16 ============" | tee -a $SUMMARY_FILE
    ...
    echo "num_total_amp_bf16: $num_total_amp_bf16" | tee -a $SUMMARY_FILE
    echo "num_passed_amp_bf16_inf: $num_passed_amp_bf16_inf" | tee -a $SUMMARY_FILE
    echo "num_failed_amp_bf16_inf: $num_failed_amp_bf16_inf" | tee -a $SUMMARY_FILE
    echo "amp_bf16_inf_acc_pass_rate: $amp_bf16_inf_acc_pass_rate" | tee -a $SUMMARY_FILE
    ...
    echo "num_passed_amp_bf16_tra: $num_passed_amp_bf16_tra" | tee -a $SUMMARY_FILE
    echo "num_failed_amp_bf16_tra: $num_failed_amp_bf16_tra" | tee -a $SUMMARY_FILE
    echo "amp_bf16_tra_acc_pass_rate: $amp_bf16_tra_acc_pass_rate" | tee -a $SUMMARY_FILE

    cd ../amp_fp16
    echo -e "============ Acc Check for HF amp_fp16 ============" | tee -a $SUMMARY_FILE
    ...
    echo "num_total_amp_fp16: $num_total_amp_fp16" | tee -a $SUMMARY_FILE
    echo "num_passed_amp_fp16_inf: $num_passed_amp_fp16_inf" | tee -a $SUMMARY_FILE
    echo "num_failed_amp_fp16_inf: $num_failed_amp_fp16_inf" | tee -a $SUMMARY_FILE
    echo "amp_fp16_inf_acc_pass_rate: $amp_fp16_inf_acc_pass_rate" | tee -a $SUMMARY_FILE
    ...
    echo "num_passed_amp_fp16_tra: $num_passed_amp_fp16_tra" | tee -a $SUMMARY_FILE
    echo "num_failed_amp_fp16_tra: $num_failed_amp_fp16_tra" | tee -a $SUMMARY_FILE
    echo "amp_fp16_tra_acc_pass_rate: $amp_fp16_tra_acc_pass_rate" | tee -a $SUMMARY_FILE

    cd ../bfloat16
    echo -e "============ Acc Check for HF bfloat16 ============" | tee -a $SUMMARY_FILE        
    ...
    echo "num_total_bfloat16: $num_total_bfloat16" | tee -a $SUMMARY_FILE
    echo "num_passed_bfloat16_inf: $num_passed_bfloat16_inf" | tee -a $SUMMARY_FILE
    echo "num_failed_bfloat16_inf: $num_failed_bfloat16_inf" | tee -a $SUMMARY_FILE
    echo "bfloat16_inf_acc_pass_rate: $bfloat16_inf_acc_pass_rate" | tee -a $SUMMARY_FILE
    ...
    echo "num_passed_bfloat16_tra: $num_passed_bfloat16_tra" | tee -a $SUMMARY_FILE
    echo "num_failed_bfloat16_tra: $num_failed_bfloat16_tra" | tee -a $SUMMARY_FILE
    echo "bfloat16_tra_acc_pass_rate: $bfloat16_tra_acc_pass_rate" | tee -a $SUMMARY_FILE

    cd ../float16
    echo -e "============ Acc Check for HF float16 ============" | tee -a $SUMMARY_FILE        
    ...
    echo "num_total_float16: $num_total_float16" | tee -a $SUMMARY_FILE
    echo "num_passed_float16_inf: $num_passed_float16_inf" | tee -a $SUMMARY_FILE
    echo "num_failed_float16_inf: $num_failed_float16_inf" | tee -a $SUMMARY_FILE
    echo "float16_inf_acc_pass_rate: $float16_inf_acc_pass_rate" | tee -a $SUMMARY_FILE
    ...
    echo "num_passed_float16_tra: $num_passed_float16_tra" | tee -a $SUMMARY_FILE
    echo "num_failed_float16_tra: $num_failed_float16_tra" | tee -a $SUMMARY_FILE
    echo "float16_tra_acc_pass_rate: $float16_tra_acc_pass_rate" | tee -a $SUMMARY_FILE

    cd ../float32
    echo -e "============ Acc Check for HF float32 ============" | tee -a $SUMMARY_FILE        
    ...
    echo "num_total_float32: $num_total_float32" | tee -a $SUMMARY_FILE
    echo "num_passed_float32_inf: $num_passed_float32_inf" | tee -a $SUMMARY_FILE
    echo "num_failed_float32_inf: $num_failed_float32_inf" | tee -a $SUMMARY_FILE
    echo "float32_inf_acc_pass_rate: $float32_inf_acc_pass_rate" | tee -a $SUMMARY_FILE
    ...
    echo "num_passed_float32_tra: $num_passed_float32_tra" | tee -a $SUMMARY_FILE
    echo "num_failed_float32_tra: $num_failed_float32_tra" | tee -a $SUMMARY_FILE
    echo "float32_tra_acc_pass_rate: $float32_tra_acc_pass_rate" | tee -a $SUMMARY_FILE
fi

if [[ $SUITE == "timm_models" || $SUITE == "all" ]]; then
    echo -e "========================================================================="
    echo -e "timm_models accuracy results check"
    echo -e "========================================================================="

    cd ${WORKSPACE}/inductor_log/timm_models
    cd amp_bf16
    echo -e "============ Acc Check for TM amp_bf16 ============" | tee -a $SUMMARY_FILE
    ...
    cd ../amp_fp16
    echo -e "============ Acc Check for TM amp_fp16 ============" | tee -a $SUMMARY_FILE
    ...
    cd ../bfloat16
    echo -e "============ Acc Check for TM bfloat16 ============" | tee -a $SUMMARY_FILE        
    ...
    cd ../float16
    echo -e "============ Acc Check for TM float16 ============" | tee -a $SUMMARY_FILE        
    ...
    cd ../float32
    echo -e "============ Acc Check for TM float32 ============" | tee -a $SUMMARY_FILE        
...
if [[ $SUITE == "torchbench" || $SUITE == "all" ]]; then
    echo -e "========================================================================="
    echo -e "torchbench accuracy results check"
    echo -e "========================================================================="

    cd ${WORKSPACE}/inductor_log/torchbench
    cd amp_bf16
    echo -e "============ Acc Check for torchbench amp_bf16 ============" | tee -a $SUMMARY_FILE
    ...
    cd ../amp_fp16
    echo -e "============ Acc Check for torchbench amp_fp16 ============" | tee -a $SUMMARY_FILE
    ...
    cd ../bfloat16
    echo -e "============ Acc Check for torchbench bfloat16 ============" | tee -a $SUMMARY_FILE        
    ...
    cd ../float16
    echo -e "============ Acc Check for torchbench float16 ============" | tee -a $SUMMARY_FILE        
    ...
    cd ../float32
    echo -e "============ Acc Check for torchbench float32 ============" | tee -a $SUMMARY_FILE        
